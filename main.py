...
from state_template_generator import generator
...
parser.add_argument('-batchsize', type=int, help='Seed',  default=RESNET101_SIZE)
...
print(state_template.x, state_template.edge_index, state_template.batch)
